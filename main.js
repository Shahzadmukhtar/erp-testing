...
var map = {
	"./views/color-codes/color-codes.module": [
		"./src/app/views/color-codes/color-codes.module.ts",
		"default~views-color-codes-color-codes-module~views-dashboard-dashboard-module~views-rota-rota-module~d75a6d52",
		"common",
		"views-color-codes-color-codes-module"
	],
	...
	"./views/rota/rota.module": [
		"./src/app/views/rota/rota.module.ts",
		"default~views-color-codes-color-codes-module~views-dashboard-dashboard-module~views-rota-rota-module~d75a6d52",
		"default~views-rota-rota-module~views-scheduler-scheduler-module",
		"common",
		"views-rota-rota-module"
	],
	"./views/scheduler/scheduler.module": [
	...
	"./views/site-codes/site-codes.module": [
...
/* harmony import */ var _services_shared_color_code_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./services/shared/color-code.service */ "./src/app/services/shared/color-code.service.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [_services_shared_color_code_service__WEBPACK_IMPORTED_MODULE_9__["ColorCodeService"], {
...
var routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'color-codes',
                loadChildren: './views/color-codes/color-codes.module#ColorCodesModule'
            },
            {
                path: 'site-codes',
                loadChildren: './views/site-codes/site-codes.module#SiteCodesModule'
            },
            {
                path: 'scheduler',
            ...
            {
                path: 'rota',
                loadChildren: './views/rota/rota.module#RotaModule'
            }
        ]
    },
];
...
module.exports = "<app-header\n  [navbarBrandRouterLink]=\"['/dashboard']\"\n  [fixed]=\"true\"\n  \n  [navbarBrandFull]=\"{src: 'assets/img/brand/logo_ram.png', width: 89, height: 45, alt: 'CoreUI Logo'}\"\n  [navbarBrandMinimized]=\"{src: 'assets/img/brand/sygnet.svg', width: 30, height: 30, alt: 'CoreUI Logo'}\"\n  [sidebarToggler]=\"'lg'\"\n  [asideMenuToggler]=\"'lg'\"\n  >\n  <ul class=\"nav navbar-nav d-md-down-none mr-auto\">\n    <li class=\"nav-item px-3\">\n      <a class=\"nav-link\" href=\"#\">Dashboard</a>\n    </li>\n  </ul>\n</app-header>\n<div class=\"app-body\">\n  <app-sidebar [fixed]=\"true\" [display]=\"'lg'\">\n    <app-sidebar-nav [navItems]=\"navItems\" [perfectScrollbar] [disabled]=\"sidebarMinimized\"></app-sidebar-nav>\n    <app-sidebar-minimizer></app-sidebar-minimizer>\n  </app-sidebar>\n  <!-- Main content -->\n  <main class=\"main\">\n    <!-- Breadcrumb -->\n    <cui-breadcrumb></cui-breadcrumb>\n    <div class=\"container-fluid\">\n      <router-outlet></router-outlet>\n    </div><!-- /.container-fluid -->\n  </main>\n  <app-aside [fixed]=\"true\" [display]=\"false\">\n\n  </app-aside>\n</div>\n<app-footer>\n  <span><a href=\"http://ramdistribution.co.uk/\" target=\"_blank\">Ram Distribution</a> &copy; 2019 RAM Distribution.</span>\n  <span class=\"ml-auto\">Powered by <a href=\"https://isetech.co\" target=\"_blank\">iseTech</a></span>\n</app-footer>\n"
...
/***/ "./src/app/services/shared/color-code.service.ts":
/*!*******************************************************!*\
  !*** ./src/app/services/shared/color-code.service.ts ***!
  \*******************************************************/
/*! exports provided: ColorCodeService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ColorCodeService", function() { return ColorCodeService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var ColorCodeService = /** @class */ (function () {
    function ColorCodeService(http) {
        this.http = http;
        ...
        this.messageSource = new rxjs__WEBPACK_IMPORTED_MODULE_4__["BehaviorSubject"](this.colors);
        this.currentMessage = this.messageSource.asObservable();
    }
    ColorCodeService.prototype.changeMessage = function (message) {
        this.messageSource.next(message);
    };
    ColorCodeService.prototype.initializeFormgroup = function () {
        this.form.setValue({
            id: '',
            code: '',
            description: '',
    ...
    ColorCodeService.prototype.save_color_status = function (color_status) {
        this.http.post("http://localhost:3002/create-status-code", { color_status: color_status })
            .subscribe(function (res) {
            console.log(res);
        });
    };
    ColorCodeService.prototype.update_color_status = function (color_status) {
        this.http.post("http://localhost:3002/update-status-code", { color_status: color_status })
            .subscribe(function (res) {
            console.log(res);
        });
    };
    ColorCodeService.prototype.getColorList = function () {
        return this.http.get("http://localhost:3002/color_status");
    };
    ColorCodeService.prototype.populateform = function (formvalue) {
        this.form.setValue(formvalue);
    };
    ColorCodeService.prototype.delete_status = function (color_status) {
        this.http.post("http://localhost:3002/delete-status-code", { color_status: color_status })
            .subscribe(function (res) {
            console.log(res);
        });
    };
    ColorCodeService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]])
    ], ColorCodeService);
    return ColorCodeService;
}());
...
module.exports = __webpack_require__(/*! E:\ram-development\src\main.ts */"./src/main.ts");
